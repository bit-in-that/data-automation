...
write_parquet(player_selections_long, "2026/output/sc_player_selections_long.parquet")

if(FALSE) { # not performed by action
  player_selections_long <- read_parquet("2026/output/sc_player_selections_long.parquet")
}
